...
insert into uicontrols(id, name) values(5015, 'page/slide-out-help-2');
insert into uicontrols(id, name) values(5016, 'page/smooth-vert-transition-1');
insert into uicontrols(id, name) values(5017, 'page/edit-contract-spec');
insert into uicontrols(id, name) values(5018, 'page/reports/grid-v:');
insert into uicontrols(id, name) values(5019, 'page/reports/my-searches');
insert into uicontrols(id, name) values(5020, 'page/grid-page-with-filters');
insert into uicontrols(id, name) values(5021, 'page/grid-page-with-row-selection');
insert into uicontrols(id, name) values(5022, 'page/grid-page-with-custom-filter');
insert into uicontrols(id, name) values(5023, 'page/tab-group-page');
insert into uicontrols(id, name) values(5024, 'page/pretty-tabs');
insert into uicontrols(id, name) values(5025, 'page/switch-tabs');
insert into uicontrols(id, name) values(5026,  'page/dashboard');
insert into uicontrols(id, name) values(5027,  'page/dashboard/pie-chart');
insert into uicontrols(id, name) values(5028,  'page/chips-with-textbox');
insert into uicontrols(id, name) values(5029,  'page/chips-with-autocomplete');
insert into uicontrols(id, name) values(5030,  'page/grid-page-with-chip-selection');
