package com.lessons.sync.security;
...
public enum SSLContextFactory
{
    ...
    {
        logger.debug("makeContext() started.  aKeyJksFile={}  keyPassword-->{}<--   aTrustJksFile={}  trustPassword-->{}<--",
                keyJksFile.toString(), keyPassword, trustJksFile.toString(), trustPassword);
